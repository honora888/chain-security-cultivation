...
const STATUS_BY_ERROR: Record<ChainStatusErrorCode, number> = {
  ...
  RPC_UNAVAILABLE: 502,
  RPC_HTTP_ERROR: 502,
  RPC_CONTENT_TYPE_ERROR: 502,
  RPC_JSON_PARSE_ERROR: 502,
  RPC_PROTOCOL_ERROR: 502,
  RPC_REMOTE_ERROR: 502,
  CHAIN_ID_MISMATCH: 502,
  CONTRACT_NOT_DEPLOYED: 502,
  MALFORMED_RESULT: 502,
  ABI_DECODE_ERROR: 502,
